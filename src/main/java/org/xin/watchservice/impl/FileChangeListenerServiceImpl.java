...
import org.xin.watchservice.FileChangeListenerService;
import org.xin.watchservice.Observer;
...
public class FileChangeListenerServiceImpl implements FileChangeListenerService {
  ...
  public FileChangeListenerServiceImpl(Observer observer) {
  ...
  private void copyFile(FileChangeEvent event) throws IOException {
    ...
    final String to = "/Users/bender/tmp/" + event.fileName().toString()
        + ".copy";
